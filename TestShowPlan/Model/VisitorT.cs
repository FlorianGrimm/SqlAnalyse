namespace Sqlserver.Showplan {
    ...
    public class Visitor<T> {
        ...
        public virtual T Visit(AdaptiveJoinType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(AffectingConvertWarningType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(AggregateType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ArithmeticType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(AssignType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(BaseStmtInfoType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(BatchHashTableBuildType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(BitmapType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(CLRFunctionType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(CollapseType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ColumnGroupType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ColumnReferenceListType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ColumnReferenceType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ColumnType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(CompareType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ComputeScalarType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ConcatType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ConditionalType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ConstantScanType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ConstantScanTypeValues node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ConstType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ConvertType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(CreateIndexType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(CursorPlanType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(CursorPlanTypeOperation node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(DefinedValuesListType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(DefinedValuesListTypeDefinedValue node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(DefinedValuesListTypeDefinedValueValueVector node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(FilterType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ForeignKeyReferenceCheckType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ForeignKeyReferencesCheckType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(FunctionType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(GenericType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(GuessedSelectivityType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(HashSpillDetailsType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(HashType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(IdentType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(IndexedViewInfoType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(IndexScanType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(InternalInfoType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(IntrinsicType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(LogicalType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(MemoryFractionsType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(MemoryGrantType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(MemoryGrantWarningInfo node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(MergeType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(MissingIndexesType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(MissingIndexGroupType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(MissingIndexType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(MultAssignType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(NestedLoopsType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ObjectType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(OptimizerHardwareDependentPropertiesType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(OptimizerStatsUsageType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(OrderByType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(OrderByTypeOrderByColumn node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ParallelismType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ParallelismTypeActivation node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ParallelismTypeBrickRouting node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ParameterizationType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(PutType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(QueryExecTimeType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(QueryPlanType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ReceivePlanType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ReceivePlanTypeOperation node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(RelOpBaseType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(RelOpType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(RemoteFetchType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(RemoteModifyType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(RemoteQueryType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(RemoteRangeType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(RemoteType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(RollupInfoType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(RollupLevelType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(RowsetType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(RunTimeInformationType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(RunTimeInformationTypeRunTimeCountersPerThread node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(RunTimePartitionSummaryType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(RunTimePartitionSummaryTypePartitionsAccessed node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(RunTimePartitionSummaryTypePartitionsAccessedPartitionRange node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ScalarExpressionListType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ScalarExpressionType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ScalarInsertType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ScalarSequenceType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ScalarType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ScanRangeType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SeekPredicateNewType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SeekPredicatePartType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SeekPredicatesType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SeekPredicateType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SegmentType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SequenceType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SetOptionsType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SetPredicateElementType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ShowPlanXML node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ShowPlanXMLBatchSequence node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ShowPlanXMLBatchSequenceBatch node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SimpleIteratorOneChildType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SimpleUpdateType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SingleColumnReferenceType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SortSpillDetailsType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SortType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SpillToTempDbType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SplitType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SpoolType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(StarJoinInfoType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(StatsInfoType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(StmtBlockType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(StmtCondType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(StmtCondTypeCondition node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(StmtCondTypeElse node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(StmtCondTypeThen node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(StmtCursorType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(StmtReceiveType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(StmtSimpleType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(StmtUseDbType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(StreamAggregateType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SubqueryType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(SwitchType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(TableScanType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(TableValuedFunctionType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ThreadReservationType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(ThreadStatType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(TopSortType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(TopType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(TraceFlagListType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(TraceFlagType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(UDAggregateType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(UDFType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(UDTMethodType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(UDXType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(UnmatchedIndexesType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(UpdateType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(WaitStatListType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(WaitStatType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(WaitWarningType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(WarningsType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(WindowAggregateType node, T state) => node.AcceptExplicit(this, state);
        public virtual T Visit(WindowType node, T state) => node.AcceptExplicit(this, state);
